    ...
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<ActionResult> Delete(int id)
        {
            try
            {
                ...
                // If deletion fails, add the error message to TempData
                TempData["ErrorMessage"] = response.ValidationError;
            }
            catch (Exception ex)
            {
                // If an exception occurs, add the exception message to TempData
